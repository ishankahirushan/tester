...
public class SubjectService {
    ...
    public Subject updateSubject(Long id, String name, Long classId, Boolean hasExam,
                                  String weightingConfig, Long updatedById) {
        ...
        subject.setSchoolClass(cls);
        subject.setHasExam(hasExam);
        subject.setWeightingConfig(weightingConfig);

        Subject saved = subjectRepository.save(subject);
        activityLogService.log(updatedById, "SUBJECT_UPDATED", "Subject: " + name);
        return saved;
    }

    public void deleteSubject(Long id, Long deletedById) {
        Subject subject = subjectRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Subject", id));
        subjectRepository.delete(subject);
        activityLogService.log(deletedById, "SUBJECT_DELETED", "Subject: " + subject.getName());
    }
}
